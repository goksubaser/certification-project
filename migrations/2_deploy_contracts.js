...
//////////////////////////////////////////////// DIPLOMA REQUEST TESTING ///////////////////////////////////////////////
    ...
    // await request.createDiplomaRequest("1", "0x5ED0FD501C775603D388dbA83155DBF80E919f37", {from: "0x9979e393F2aA3284C243d04C72F8ab738893c69C"})//Student1 Department2
    // await request.createDiplomaRequest("2", "0xfA9F999f088B88808397B7312F9a4792B9dcB13D", {from: "0x203485A51cDf5c5Cac271790fD45002060f8b842"})//Student2 Department3
...
//////////////////////////////////////////////// COURSE EDITING TESTING ////////////////////////////////////////////////
    ...
    console.log("Courses are bing minted...")
    const course = await Course.deployed()
    await course.mint("Course0-Instructor0", "0x9aB9157db62e8C4eE0Bd0924B0A3bB7868070a92")
    await course.mint("Course1-Instructor1", "0x5ED0FD501C775603D388dbA83155DBF80E919f37")
    await course.mint("Course2-Instructor0", "0x9aB9157db62e8C4eE0Bd0924B0A3bB7868070a92")
    await course.mint("Course3-Instructor1", "0x5ED0FD501C775603D388dbA83155DBF80E919f37")
    await course.mint("Course4-Instructor0", "0x9aB9157db62e8C4eE0Bd0924B0A3bB7868070a92")
    await course.mint("Course5-Instructor1", "0x5ED0FD501C775603D388dbA83155DBF80E919f37")
    await course.mint("Course6-Instructor0", "0x9aB9157db62e8C4eE0Bd0924B0A3bB7868070a92")
    await course.mint("Course7-Instructor1", "0x5ED0FD501C775603D388dbA83155DBF80E919f37")
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
